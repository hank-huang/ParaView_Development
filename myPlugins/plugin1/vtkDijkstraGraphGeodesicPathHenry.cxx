/*=========================================================================
  ...
  Module:  vtkDijkstraGraphGeodesicPathHenry.cxx
  Language:  C++
...
=========================================================================*/
#include "vtkDijkstraGraphGeodesicPathHenry.h"
...
vtkCxxSetObjectMacro(vtkDijkstraGraphGeodesicPathHenry,RepelVertices,vtkPoints);

//----------------------------------------------------------------------------
vtkDijkstraGraphGeodesicPathHenry::vtkDijkstraGraphGeodesicPathHenry()
{
...
//----------------------------------------------------------------------------
void vtkDijkstraGraphGeodesicPathHenry::GetCumulativeWeights(vtkDoubleArray *weights)
{
  if (!weights)
  {
    return;
...
//----------------------------------------------------------------------------
int vtkDijkstraGraphGeodesicPathHenry::RequestData(
...
void vtkDijkstraGraphGeodesicPathHenry::GenCurvature(vtkPolyData *in) {
...
void vtkDijkstraGraphGeodesicPathHenry::CalcMinMaxCurv() {
  double temp = 0.0;
  for (int i = 0; i < this->NumberOfVertices; i++) {
...
//----------------------------------------------------------------------------
void vtkDijkstraGraphGeodesicPathHenry::Initialize( vtkDataSet *inData )
{
...
//----------------------------------------------------------------------------
void vtkDijkstraGraphGeodesicPathHenry::Reset()
{
...
//----------------------------------------------------------------------------
double vtkDijkstraGraphGeodesicPathHenry::CalculateStaticEdgeCost(
...
void vtkDijkstraGraphGeodesicPathHenry::BuildAdjacency(vtkDataSet *inData)
{
...
double vtkDijkstraGraphGeodesicPathHenry::CalculateCostWithCurv(vtkIdType i, vtkIdType j, double dist) {
...
//----------------------------------------------------------------------------
void vtkDijkstraGraphGeodesicPathHenry::TraceShortestPath(
...
//----------------------------------------------------------------------------
void vtkDijkstraGraphGeodesicPathHenry::Relax(const int& u, const int& v, const double& w)
{
...
//----------------------------------------------------------------------------
void vtkDijkstraGraphGeodesicPathHenry::ShortestPath( vtkDataSet *inData,
                                                int startv, int endv )
{
  int u, v;
...
//----------------------------------------------------------------------------
void vtkDijkstraGraphGeodesicPathHenry::PrintSelf(ostream& os, vtkIndent indent)
{

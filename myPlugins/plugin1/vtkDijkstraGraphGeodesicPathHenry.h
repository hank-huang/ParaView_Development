/*=========================================================================
  ...
  Module:    vtkDijkstraGraphGeodesicPathHenry.h
...
=========================================================================*/
/**
 * @class   vtkDijkstraGraphGeodesicPathHenry
...
#ifndef vtkDijkstraGraphGeodesicPathHenry_h
#define vtkDijkstraGraphGeodesicPathHenry_h
...
class VTKFILTERSMODELING_EXPORT vtkDijkstraGraphGeodesicPathHenry :
...
public:
   ...
   */
  static vtkDijkstraGraphGeodesicPathHenry *New();

  //@{
  /**
   * Standard methods for printing and determining type information.
   */
  vtkTypeMacro(vtkDijkstraGraphGeodesicPathHenry,vtkGraphGeodesicPath);
...
protected:
  vtkDijkstraGraphGeodesicPathHenry();
  ~vtkDijkstraGraphGeodesicPathHenry() override;
...
private:
  vtkDijkstraGraphGeodesicPathHenry(const vtkDijkstraGraphGeodesicPathHenry&) = delete;
  void operator=(const vtkDijkstraGraphGeodesicPathHenry&) = delete;

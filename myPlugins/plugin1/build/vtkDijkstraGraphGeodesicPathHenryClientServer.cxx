// ClientServer wrapper for vtkDijkstraGraphGeodesicPathHenry object
//
...
vtkObjectBase *vtkDijkstraGraphGeodesicPathHenryClientServerNewCommand(void* /*ctx*/)
{
  return vtkDijkstraGraphGeodesicPathHenry::New();
}


int VTK_EXPORT vtkDijkstraGraphGeodesicPathHenryCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDijkstraGraphGeodesicPathHenry *op = vtkDijkstraGraphGeodesicPathHenry::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDijkstraGraphGeodesicPathHenry.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkDijkstraGraphGeodesicPathHenry  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDijkstraGraphGeodesicPathHenry, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDijkstraGraphGeodesicPathHenry_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDijkstraGraphGeodesicPathHenry", vtkDijkstraGraphGeodesicPathHenryClientServerNewCommand);
    csi->AddCommandFunction("vtkDijkstraGraphGeodesicPathHenry", vtkDijkstraGraphGeodesicPathHenryCommand);
    }
}
